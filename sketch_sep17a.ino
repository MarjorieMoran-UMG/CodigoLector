...
const char *ssid = "Wifii";  //ENTER YOUR WIFI SETTINGS
const char *password = "rara12345";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://biometricattendance.online/getdata.php"; //computer IP or the server domain
...
uint8_t getFingerprintEnroll() {
  ...
  confirmAdding();
  return p; // Agregar un return al final de la función
}
//******************Check if there a Fingerprint ID to add******************
void confirmAdding(){
